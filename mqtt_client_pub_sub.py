...
# subscribe to all topics of lab1 by using the wildcard "#"
client.subscribe("lab/#", qos=1)

# a single publish, this can also be done in loops, etc.
client.publish("lab/temperature", payload="33", qos=1)
client.publish("lab/presence", payload="true", qos=1)
